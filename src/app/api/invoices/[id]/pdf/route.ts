...
export async function GET(request: NextRequest, { params }: { params: { id: string } }) {
  try {
    ...
    const options = { format: 'A4', printBackground: true } as any;
    ...
    try {
      ...
      return NextResponse.json({ error: 'Gagal menghasilkan PDF. Pastikan lingkungan mendukung headless Chromium.' }, { status: 500 });
    }
